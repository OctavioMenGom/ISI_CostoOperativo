...
function calcularUtilidadAntesDeIVA(costoCotizacion, inversion, gastosTotales) {
    return (costoCotizacion - inversion - gastosTotales) * 0.3;
}

function calcularResultadoOperacion(costoCotizacion, inversion, gastosTotales, utilidadAntesIVA) {
    return costoCotizacion - inversion - gastosTotales - utilidadAntesIVA;
}
...
function calcularYMostrarResultados() {
    let costoCotizacion = parseFloat(document.querySelector('input[name="costoCotizacion"]').value);
    let inversion = parseFloat(document.querySelector('input[name="inversion"]').value);
    let gastosTotales = parseFloat(document.querySelector('input[name="gastosTotales"]').value);

    let utilidadAntesIVA = calcularUtilidadAntesDeIVA(costoCotizacion, inversion, gastosTotales);
    document.querySelector('input[name="utilidadAntesIVA"]').value = formatearMoneda(utilidadAntesIVA);

    let resultadoOperacion = calcularResultadoOperacion(costoCotizacion, inversion, gastosTotales, utilidadAntesIVA);
    document.querySelector('input[name="resultadoOperacion"]').value = formatearMoneda(resultadoOperacion);
}
